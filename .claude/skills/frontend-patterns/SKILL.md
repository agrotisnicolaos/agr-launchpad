...
description: Use when implementing frontend logic - component structure, state management, data fetching, rendering performance. Examples use React/Next.js. Defers visual taste and design-token decisions to the frontend-design plugin.
origin: ECC
---
