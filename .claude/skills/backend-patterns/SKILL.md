...
description: Use when writing server-side code - service layering, data access, caching, queues, database optimization. Examples use Node.js/Express/Next.js but the patterns are general; for endpoint contract design use api-design, for error/retry patterns use error-handling.
origin: ECC
---
